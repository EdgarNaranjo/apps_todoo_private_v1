...
class StockModelWzard(models.TransientModel):
    ...
    state_invoice = fields.Boolean('Only Paid', help='Mostrar solo transaciones pagadas', track_visibility='onchange')
    invoice_filters_ids = fields.Many2many('account.move', 'account_invoice_wizard_rel', 'wizard_id', 'invoice_id', 'Customer move lines', track_visibility='onchange')
    supplier_filters_ids = fields.Many2many('account.move', 'account_invoice_partner_id', 'wizard_id', 'invoice_id', 'Supplier move lines', track_visibility='onchange')
